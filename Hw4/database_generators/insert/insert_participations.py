    ...
    try:
        with open("./queries/insert_participations.sql", "w", encoding="utf-8") as f:
            with conn.cursor() as cursor:
                ...
                pairs = set()
                insert_query = \
                    "INSERT INTO races_pilots (race_id, pilot_id, start_position, need_accommodation, user_id) VALUES "
                values = []
                ...
                for i in range(10000000):
                    ...
                    values.append(f"({race_id}, {pilot_id}, '{start_position}', '{need_accommodation}', {user_id})")
