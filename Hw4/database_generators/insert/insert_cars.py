    ...
    try:
        with open("./queries/insert_cars.sql", "w", encoding="utf-8") as f:
            with conn.cursor() as cursor:
                ...
                insert_query = \
                    "INSERT INTO Cars (brand, motorization, gear_box, cylindrical_capacity, horse_power, pilot_id) VALUES "
                values = []
                for i in range(1000000):
                    ...
                    values.append(
                        f"('{brand}', '{motorization}', '{gear_box}', {cylindrical_capacity}, {horse_power}, {pilot_id})")
                    if len(values) == 1000:
